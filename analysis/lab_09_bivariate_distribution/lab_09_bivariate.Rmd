...
read_chunk("./analysis/lab_09_bivariate_distribution/lab_09_bivariate.R") 
```
...
```{r g1a, echo=echoChunks, results='show', message=FALSE, warning=warningChunks}
```

# Scatterplot
```{r g2, echo=echoChunks, results='show', message=FALSE, warning=warningChunks}
```

Let's augment the graph with informative thresholds:

```{r g2a, echo=echoChunks, results='show', message=FALSE, warning=warningChunks}
```
